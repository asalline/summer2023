...
def train_network(net, loss_function, n_train=300, batch_size=25): #g_train, g_test, f_train, f_test, 
    ...
    for i in range(n_train):
        ...
        if i % 100 == 0:
            ...
            test_loss = loss_test(outs2, f_test).item()**0.5
...
running_loss, running_test_loss, ready_to_eval = train_network(UNet, loss_function, \
                                                               n_train=50000, batch_size=1) # g_train, g_test, f_train, f_test
