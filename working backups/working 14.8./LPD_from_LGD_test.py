...
import numpy as np
from LPD_from_LGD_test_functions import get_images, geometry_and_ray_trafo, LGD
...
images = get_images('/scratch2/antti/summer2023/usable_walnuts', amount_of_images=6500, scale_number=2)
...
test_images = get_images('/scratch2/antti/summer2023/test_walnut', amount_of_images=200, scale_number=2)
...
LGD = LGD(adjoint_operator_module, ray_transform_module, 3,1,2,1,n_iter=10, device=device).to(device)
...
running_loss, running_test_loss, ready_to_eval = train_network(LGD, loss_function, f_images, \
                                                                  ...
                                                                  g_test_sinograms, n_train=30000, \
                                                                  batch_size=1)
...
LGD_reconstruction, _ = ready_to_eval(f_test_rec_images[None,image_number,:,:,:], g_test_sinograms[None,image_number,:,:,:])
