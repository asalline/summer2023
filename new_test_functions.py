...
def random_ellipsoids_and_sinogram(domain, operator, num_of_ellipsoids):
    ...
    # noisy_sinogram = sinogram + np.random.normal(0, 0.02, size=(np.shape(sinogram)[0], np.shape(sinogram)[1]))
